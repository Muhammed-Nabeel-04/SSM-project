          ...
          child: Column(children: [
            ...
            if (scores != null) GridView.count(
              ...
              children: [
                ...
                ScoreRingCard(score: (scores['development'] as num).toDouble(), maxScore: 100, label: 'Dev', color: AppColors.development, icon: Icons.workspace_premium_rounded),
                ScoreRingCard(score: (scores['skill'] as num).toDouble(), maxScore: 100, label: 'Skill', color: AppColors.skill, icon: Icons.trending_up_rounded),
            ...
            if (_data?['mentor_remarks'] != null)
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: AppColors.mentorColor.withOpacity(0.2)),
                ),
            ...
            Card(
              child: Padding(
                ...
                child: Column(children: [
                  const SectionHeader(
                      title: 'HOD Feedback', icon: Icons.rate_review_rounded,
