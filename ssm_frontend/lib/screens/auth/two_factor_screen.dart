...
class _TwoFactorScreenState extends State<TwoFactorScreen> {
  ...
  Future<void> _disableTwoFA() async {
    ...
    if (code.length != 6) {
      setState(
          () => _error = 'Enter your current 6-digit code to disable 2FA.');
      return;
    }
    setState(() {
      _loading = true;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // ── Status Banner ──────────────────────────────────────────
            _StatusBanner(
                isEnabled: is2FAEnabled || _pageState == _PageState.enabled),
            ...
            if (_pageState == _PageState.scanQR) ...[
              ...
              const _Step(
                  number: 2,
                  title: 'Scan the QR Code or Enter Manually',
                  body:
                      'Open the authenticator app → tap "+" → scan the secret below manually.'),
              ...
              const _Step(
                  ...
                  body:
                      'After adding the account in your authenticator app, enter the code it shows below.'),
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label:
                      Text(_loading ? 'Verifying...' : 'Verify & Enable 2FA'),
                  style: ElevatedButton.styleFrom(
            ...
            if (_pageState == _PageState.enabled) ...[
              ...
              Container(
                ...
                child: const Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8),
                    Text(
                        'Each time you sign in, you will be asked for your '
              ...
              const SizedBox(height: 4),
              const Text(
                  'Enter your current authenticator code to remove 2FA from your account.',
                  style:
  ...
  Widget build(BuildContext context) {
    return const Column(children: [
      _InfoRow(
        ...
        body:
            'Even if someone knows your password, they cannot access your account without your phone.',
      ),
      SizedBox(height: 12),
      _InfoRow(
        ...
        title: 'Works offline',
        body:
            'Codes are generated by your authenticator app. No internet or SMS needed.',
      ),
      SizedBox(height: 12),
      _InfoRow(
        ...
        title: 'Free forever',
        body:
            'Works with Google Authenticator, Microsoft Authenticator, or Authy — all free.',
      ),
    ]);
  }
}
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: const InputDecoration(
        hintText: '000000',
        hintStyle: TextStyle(
            letterSpacing: 14, fontSize: 28, color: AppColors.textLight),
        counterText: '',
